...
public class SpringCoil extends JavaPlugin {
	...
	//ClassListeners
	private final SpringCoilCommandExecutor commandExecutor = new SpringCoilCommandExecutor(this);
	private final SpringCoilEventListener eventListener = new SpringCoilEventListener(this);
	//ClassListeners
